...
def get_cells_xpos():
    ...
    xml_file = os.path.join('output_11cells_symm_v2', xml_file_root)
...
# xv_end = xpos_[:,10]
# print("xv_end =",xv_end)
# tissue_width = xpos_[:,10] - xpos_[:,0]  # rwh: NB! change these indices if reorder ICs
tissue_width = xpos_[:,10] - xpos_[:,9]  # rwh: NB! change these indices if reorder ICs
with open("pc_plot_11cells_v2.csv", 'w') as f:
